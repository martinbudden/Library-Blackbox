...
public:
    ...
    virtual bool is_blackbox_erase_mode_active(const blackbox_parameter_group_t& pg) const = 0;
    virtual bool is_blackbox_mode_activation_condition_present(const blackbox_parameter_group_t& pg) const = 0;
    virtual uint32_t get_arming_beep_time_microseconds(const blackbox_parameter_group_t& pg) const = 0;
    virtual bool are_motors_running(const blackbox_parameter_group_t& pg) const = 0;
    virtual uint32_t rc_mode_activation_mask(const blackbox_parameter_group_t& pg) const = 0; // lower 32 bits of BOX_COUNT bits
    virtual void beep(const blackbox_parameter_group_t& pg) const = 0;
};
