...
public:
    virtual void load_slow_state(blackbox_slow_state_t& slowState, const blackbox_parameter_group_t& pg) override;
    virtual void load_main_state(blackbox_main_state_t& mainState, uint32_t currentTimeUs, const blackbox_parameter_group_t& pg) override;
